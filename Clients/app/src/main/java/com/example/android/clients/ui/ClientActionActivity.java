...
public class ClientActionActivity extends BaseActivity {

    private static final String TAG = makeLogTag(ClientActionActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set content view
        setContentView(R.layout.activity_client_action);
        ...
        String[] tabTitles = getResources().getStringArray(R.array.client_actions_array);
        String[] pagerFragmentClasses = new String[]{
                ClientAcquisitionFragment.class.getCanonicalName(),
                ContactInformationFragment.class.getCanonicalName(),
                RelatedDocumentsFragment.class.getCanonicalName(),
                UserReferralsFragment.class.getCanonicalName()
        };
        ...
        ViewPager viewPager = (ViewPager) findViewById(R.id.client_actions_pager);
